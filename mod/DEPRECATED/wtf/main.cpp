...
THook(void *, _ZN4Core6Random12_initGenRandEj, void *thi, int a2) {
  ...
  *((_DWORD *) thi + 1) = a2;
  for (*((_DWORD *) thi + 625) = 1; *((_DWORD *) thi + 625) < 624; ++*((_DWORD *) thi + 625))
    *((_DWORD *) thi + *((int *) thi + 625) + 1) =
        *((_DWORD *) thi + 625) + 1812433253 * ((*((_DWORD *) thi + *((_DWORD *) thi + 625)) >> 30) ^
                                                *((_DWORD *) thi + *((_DWORD *) thi + 625)));
  result                  = thi;
  *((_DWORD *) thi + 628) = 624;
  return result;
}
...
THook(__int64, _ZN4Core6Random13_genRandInt32Ev, void *thi) {
  ...
  if (*((_DWORD *) thi + 625) < 625) {
    if (*((_DWORD *) thi + 625) == 624) *((_DWORD *) thi + 625) = 0;
  } else {
  ...
  if (*((_DWORD *) thi + 625) >= 227) {
    if (*((_DWORD *) thi + 625) >= 623)
      *((_DWORD *) thi + 624) = dword_9056508[*((_BYTE *) thi + 4) & 1] ^
                                ((*((_DWORD *) thi + 1) & 0x7FFFFFFF | *((_DWORD *) thi + 624) & 0x80000000) >> 1) ^
                                *((_DWORD *) thi + 397);
    else
      *((_DWORD *) thi + *((int *) thi + 625) + 1) =
          dword_9056508[*((_BYTE *) thi + 4 * *((_DWORD *) thi + 625) + 8) & 1] ^
          ((*((_DWORD *) thi + *((_DWORD *) thi + 625) + 2) & 0x7FFFFFFF |
            *((_DWORD *) thi + *((int *) thi + 625) + 1) & 0x80000000) >>
           1) ^
          *((_DWORD *) thi + *((_DWORD *) thi + 625) - 226);
  } else {
    *((_DWORD *) thi + *((int *) thi + 625) + 1) =
        dword_9056508[*((_BYTE *) thi + 4 * *((_DWORD *) thi + 625) + 8) & 1] ^
        ((*((_DWORD *) thi + *((_DWORD *) thi + 625) + 2) & 0x7FFFFFFF |
          *((_DWORD *) thi + *((int *) thi + 625) + 1) & 0x80000000) >>
         1) ^
        *((_DWORD *) thi + *((_DWORD *) thi + 625) + 398);
    if (*((_DWORD *) thi + 628) < 624) {
      *((_DWORD *) thi + *((int *) thi + 628) + 1) =
          *((_DWORD *) thi + 628) + 1812433253 * ((*((_DWORD *) thi + *((_DWORD *) thi + 628)) >> 30) ^
                                                  *((_DWORD *) thi + *((_DWORD *) thi + 628)));
      ++*((_DWORD *) thi + 628);
    }
  }
  v1 = (*((_DWORD *) thi + 625))++;
